...
const Pad = ({volume}) => {
  const playSound = (audio, letter) =>{
    audioId = document.querySelector("#" + letter);
...
const ToggleButton = () => {
  const toggle = () => {
    if (toggleOn){
      ...
      $("#volumebar").addClass("disableClass");
      $(".drum-pad").addClass("disableClass");
    }
    else if (!toggleOn){
      toggleOn = true;
      ...
      $("#volumebar").removeClass("disableClass");
      $(".drum-pad").removeClass("disableClass");
    }
  }
  return (
  <>
